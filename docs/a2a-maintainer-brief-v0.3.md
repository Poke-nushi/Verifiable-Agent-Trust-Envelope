# A2A Maintainer Brief For VATE v0.3
## Metadata-only admission and receipt binding

## Short Position

VATE v0.3 is not asking A2A to become a trust, payment, identity, or policy protocol.
...
whether the VATE v0.3 boundary fits A2A-style extension metadata review.
...
VATE v0.3 focuses on that last admission decision.
...
The current AL2 v0.3 corpus includes `allow-a2a-signed-agent-card-evidence`.
